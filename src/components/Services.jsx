...
const Services = () => {
  return (
    <section id="services" className="bg-[#0F0F10] text-white py-16 md:py-24 px-4 sm:px-6 transition-colors duration-500 overflow-hidden">
      ...
      {/* GRID */}
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 perspective">
        ...
        {services.map((service, index) => (
          <motion.div
            ...
            className="
              bg-[#1A1B1F] rounded-xl p-5 sm:p-6
